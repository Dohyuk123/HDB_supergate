...
namespace HDB_supergate_{
    ...
    typedef const std::shared_ptr<std::vector<std::shared_ptr<Ctxt>>> Ctxt_vec;
    ...
    Context MakeBGVContext(int p, int d, int m, int nb_primes, int c, int l, int scale, int r);
